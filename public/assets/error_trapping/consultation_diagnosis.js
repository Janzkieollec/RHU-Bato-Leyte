        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                response.forEach(function (diagnosis) {
                    if (diagnosis.diagnosis_type === 1 && !selectedDiagnoses.includes(diagnosis.encrypted_id)) { // Check if already selected
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                response.forEach(function (medicine) {
                    if (medicine.medicine_type === 1 && !selectedMedicines.includes(medicine.encrypted_id)) { // Check if already selected
