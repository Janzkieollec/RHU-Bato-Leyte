...
@section('page-script')
<script src="{{ asset('assets/js/dental_diagnosis.js') }}"></script>
<script src="{{ asset('assets/error_trapping/dental_diagnosis.js') }}"></script>
<script src="{{ asset('assets/js/dental_diagnosis_view.js') }}"></script>
                    ...
                    <ul class="list-unstyled mb-2 mt-2">
                        <div class="row g-2">
                            <li class="d-flex align-items-center mb-1">
                                ...
                                <span class="text-primary">{{ $dentals->first()->blood_pressure ?? 'N/A' }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <i class="fa-solid fa-temperature-three-quarters"></i>
                                <span class="text-bold-600 mx-2">Body Temperature:</span>
                                <span class="text-primary">{{ $dentals->first()->body_temperature ?? 'N/A' }}</span>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <i class="fa-solid fa-ruler-vertical"></i>
                                <span class="text-bold-600 mx-2">Height:</span>
                                <span class="text-primary">{{ $dentals->first()->height ?? 'N/A' }}
                                    cm</span>
                            </li>
                            <li class="d-flex align-items-center mb-1">
                                <i class="fa-solid fa-weight-scale"></i>
                                <span class="text-bold-600 mx-2">Weight:</span>
                                <span class="text-primary">{{ $dentals->first()->weight ?? 'N/A' }}
                                    kg</span>
                            </li>
                            <li class="d-flex align-items-start mb-1 flex-wrap">
                                ...
                                <div class="chief-complaints-container flex-grow-1">
                                    <span class="text-primary chief-complaints">
                                        ...
                                        {{ $dental->chief_complaints }}
                                        ({{ $dental->number_of_days }} days)
                                        {{ !$loop->last ? ', ' : '' }}
                                        @endforeach
                                    </span>
                                </div>
                ...
                <div class="card-body text-nowrap mr-2 h-100">
                    <div class="row">
                        ...
                        <div class="col-md-4 d-flex align-items-end justify-content-end">
                            <h5>
                                <a href="/dentist-patients" class="form-text">
