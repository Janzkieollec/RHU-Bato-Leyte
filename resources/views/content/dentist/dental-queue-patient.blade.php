...
// Setup Laravel Echo to listen for the 'patient.added' event
Echo.channel('dental-queueing')
    .listen('.dental-queueing.added', (event) => {
        let newPatient = {
            ...
            patient_id: event.encryptedPatientId, // Use the encrypted patient ID
        };

        // Construct a new row for the patient table
        let newRow = `
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li>
                                <a href="/add-dental-diagnosis/${newPatient.patient_id}" class="dropdown-item"><i class="fa-solid fa-file-medical"></i> Add Diagnosis</a>
                            </li>
                        </ul>
                    </div>
                </td>
...
<script src="{{ asset('assets/js/dental_queue.js') }}"></script>
