...
@section('page-script')
<script src="{{ asset('assets/js/doctor-analytics.js') }}"></script>
...
<div class="row mb-3">
    <div class="col-lg-4 mb-3 order-0">
        <a href="/doctor-patients" class="card-link">
            <div class="card hover-card h-100">
                <div class="d-flex align-items-center row h-100">
                    <div class="col-sm-7">
                        <div class="card-body">
                            <h5 class="card-title text-dark">Total Patients Queued</h5>
                            <h4 id="totalPatientsQueue" class="card-title text-primary"></h4>
                        </div>
                    </div>
                    <div class="col-sm-5 d-flex align-items-center justify-content-center">
                        <div class="card-body pb-0 px-0 px-md-4">
                            <img src="{{ asset('assets/img/illustrations/advice.png') }}" alt="Diagnosis Added Today"
                                class="img-fluid">
                        </div>
                    </div>
                </div>
    ...
    <div class="col-lg-4 mb-3 order-0">
        <a href="/patients-consultation-diagnosis" class="card-link">
            <div class="card hover-card h-100">
                <div class="d-flex align-items-center row h-100">
                    <div class="col-sm-7">
                        <div class="card-body">
                            <h5 class="card-title text-dark">Total Diagnosis</h5>
                            <h4 id="totalDiagnosis" class="card-title text-primary"></h4>
                        </div>
                    </div>
                    <div class="col-sm-5 d-flex align-items-center justify-content-center">
                        <div class="card-body pb-0 px-0 px-md-4">
                            <img src="{{ asset('assets/img/illustrations/statistical-analysis.png') }}"
                                alt="Total Patients" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-lg-4 mb-3 order-0">
        <div class="card hover-card h-100">
            <div class="d-flex align-items-center row h-100">
                <div class="col-sm-7">
                    <div class="card-body">
                        <h5 class="card-title text-dark">Diagnosis Added Today</h5>
                        <h4 id="totalDiagnosisToday" class="card-title text-primary"></h4>
                    </div>
                </div>
                <div class="col-sm-5 d-flex align-items-center justify-content-center">
                    <div class="card-body pb-0 px-0 px-md-4">
                        <img src="{{ asset('assets/img/illustrations/calendar.png') }}" alt="Diagnosis Added Today"
                            class="img-fluid">
                    </div>
                </div>
            </div>
...
<div class="row mb-3">
    <div class="col mb-3">
        <ul class="nav nav-tabs rounded-3" id="analyticsTab" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link active rounded-3" id="diagnosis-tab" data-bs-toggle="tab" href="#diagnosis"
                    role="tab" aria-controls="diagnosis" aria-selected="true">Diagnosis Analytics</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link rounded-3" id="consultation-tab" data-bs-toggle="tab" href="#consultation" role="tab"
                    aria-controls="consultation" aria-selected="false">Consultation Analytics</a>
            </li>
        </ul>

        <!-- Tab Content -->
        <div class="tab-content bg-white" id="analyticsTabContent">
            <!-- Diagnosis Analytics Tab -->
            <div class="tab-pane fade show active" id="diagnosis" role="tabpanel" aria-labelledby="diagnosis-tab">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="mb-3">
                        <div id="patientsChart" class="flex-grow-1"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-pane fade" id="consultation" role="tabpanel" aria-labelledby="consultation-tab">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <label for="consultationstartMonth" class="form-label">Start Month</label>
                        <select id="consultationstartMonth" class="form-select mb-3">
                            <option value="">Select Start Month</option>
                            @foreach (range(1, 12) as $month)
                            <option value="{{ $month }}">{{ date('F', mktime(0, 0, 0, $month, 1)) }}</option>
                            @endforeach
                    ...
                    <div class="col-md-4">
                        <label for="consultationendMonth" class="form-label">End Month</label>
                        <select id="consultationendMonth" class="form-select mb-3">
                            <option value="">Select End Month</option>
                            @foreach (range(1, 12) as $month)
                            <option value="{{ $month }}">{{ date('F', mktime(0, 0, 0, $month, 1)) }}</option>
                            @endforeach
                    ...
                    <div class="col-md-4">
                        <label for="diagnosisInput" class="form-label">Year</label>
                        <select id="consultationyearSelect" class="form-select mb-3">
                            <option value="">Select Year</option>
                            @for ($i = 2019; $i <= date('Y'); $i++) <option value="{{ $i }}">{{ $i }}</option>
                                @endfor
                        </select>
                    ...
                    <div class="col-md-4">
                        <label for="diagnosisInput" class="form-label">Barangay</label>
                        <select id="consultationselectBarangay" class="form-select mb-3">
                            <option value="">Select Barangay</option>
                            <!-- Barangay options will be populated by JS -->
                        </select>
                    </div>
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <select name="chief_complaint" class="form-select form-control me-2 mb-0"
                            id="consultationselectChiefComplaint" aria-label="Default select example" required>
                            <option value="" selected disabled>Select Symptoms</option>
                        </select>
                    </div>
                </div>

                <div class="h-1000" id="consultationChart"></div>
            </div>
        </div>
    </div>
</div>
