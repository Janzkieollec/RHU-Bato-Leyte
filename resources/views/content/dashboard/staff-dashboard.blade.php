...
@section('page-script')
<script src="{{ asset('assets/js/staff-analytics.js') }}"></script>
@endsection
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewPatientModalLabel">Yearly Consultation</h5>
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
        <a class="nav-link active" id="diagnosis-tab" data-bs-toggle="tab" href="#diagnosis" role="tab"
            aria-controls="diagnosis" aria-selected="true">Diagnosis Analytics</a>
    </li>
    <li class="nav-item" role="presentation">
...
<div class="card mb-4">
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="diagnosis" role="tabpanel" aria-labelledby="diagnosis-tab">
            <div class="row">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <label for="diagnosisyearSelect" class="form-label">Year</label>
                    ...
                    <div class="col-md-4">
                        <label for="diagnosisselectBarangay" class="form-label">Barangay</label>
                    ...
                    <div class="col-md-4">
                        <label for="diagnosisSelect" class="form-label">Disease</label>
        ...
        <div class="tab-pane fade" id="dental" role="tabpanel" aria-labelledby="dental-tab">
            <div class="row mb-3">
                <div class="col-md-6">
                    <h5 class="card-title text-dark mb-0">Dental Analytics</h5>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4 mb-4">
                    <label for="selectChiefComplaint" class="form-label">Select Symptoms</label>
                    <select id="selectChiefComplaint" class="form-select mb-0" required>
            ...
            <!-- Chart Section -->
            <div class="h-1000" id="patientsChart"></div>
        </div>
    </div>
</div>

<!-- Hidden Content (Initially visible in Diagnosis Tab) -->
<div id="diagnosisContent" class="diagnosis-content">
    <!-- First row with map -->
    <div class="row mb-3">
        <div class="col mb-3">
            <div class="card h-100">
...
<script>
// Ensure tab visibility is controlled by Bootstrap's default behavior
...
var dentalTab = document.getElementById('dental-tab');
var diagnosisTab = document.getElementById('diagnosis-tab');
var dentalContent = document.getElementById('diagnosisContent');

// Hide content when Consultation Analytics tab is active
dentalTab.addEventListener('click', function() {
