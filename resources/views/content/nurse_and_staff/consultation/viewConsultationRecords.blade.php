...
<script src="{{ asset('assets/js/consultation_view.js') }}"></script>
...
<div class="card mb-4">
    <div class="card-header">
        <h5 class="mt-2">
            <a href="/consultations" class="form-text float-end">
                <span class="bx bxs-chevron-left"></span>Back
            </a>
        </h5>
        <h6 class="mb-3 text-muted text-uppercase">Patient Information</h6>
        <div class="row">
    ...
    <div class="card-body text-nowrap mr-2">
        <div class="row">
            <div class="col-md-8 d-flex align-items-center">
                <h6 class="text-muted text-uppercase">View Consultation Records</h6>
            </div>
