...
@section('title', 'Consultation Records')

@section('page-script')
<script src="{{ asset('assets/js/patient_consultation.js') }}"></script>
@endsection
...
<div class="card">
    <div class="container-wrapper mt-3">
        <div class="row m-2 mb-3">
            <div class="col-md-8">
                <h5 class="modal-title" id="exampleModalLabel3"> Consultation Records</h5>
            </div>
        ...
        <div class="content-wrapper mt-4">
            <div class="table-responsive text-nowrap mb-4">
                <table id="tableViewConsultation" class="table table-striped table-shadow">
                    <thead>
                        <tr>
