...
class DentalQueueing implements ShouldBroadcastNow
{
    ...
    public function __construct($patientWithAddress, $encryptedPatientId, $emergencyPurposes)
    {
        ...
        $this->emergencyPurposes = $emergencyPurposes;
    ...
    {
        return new Channel('dental-queueing');
    }

    public function broadcastAs()
    {
        return 'dental-queueing.added';
    }
}